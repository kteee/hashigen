...
export const CURRENT_ACCOUNTING_PERIOD_MONTHLY_PERIODS_URL = `${baseUrl}/api/current_accounting_period/monthly_periods`
export const MONTHLY_PERIODS_URL = `${baseUrl}/api/monthly_periods`
